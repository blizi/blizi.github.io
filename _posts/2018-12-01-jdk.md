...
<img src="/images/posts/jdk/1543636110345.png" width="70%" height="70%"> 
...
<img src="/images/posts/jdk/1543634600539.png" width="70%" height="70%"> 
...
<img src="/images/posts/jdk/1543634704080.png" width="70%" height="70%">

<img src="/images/posts/jdk/1543634727555.png" width="70%" height="70%">

<p/>

点击  `新建`

<img src="/images/posts/jdk/1543634855205.png" width="70%" height="70%">

<p/>

变量名为  `JAVA_HOME`，变量值为你自己`jdk`的`安装目录`，双击打开`PATH`,或者点`编辑`<br/>

<img src="/images/posts/jdk/1543635155944.png" width="70%" height="70%">



如下：点`新建`将`%JAVA_HOME%\bin`填入最下面新建的一栏。另一种方式是将`;%JAVA_HOME%\bin`追加到PATH变量值的最后面。

<img src="/images/posts/jdk/1543635370456.png" width="70%" height="70%">
...
<img src="/images/posts/jdk/1543635612002.png" width="70%" height="70%">
